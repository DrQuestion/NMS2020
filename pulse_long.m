...
[t,simulatedAbundance] = eglv_simulation(Xinit, M_mu_eps, [0 200], time_points, pert_matrix, C_diff);
 
sgt=sgtitle('Prediction of the microbial composition in the cecum with pulse perturbation and 200 days range of simulation','fontweight','bold','fontsize',20);
subplot(3,1,3)
...
[t1,simulatedAbundance1] = eglv_simulation(Xinit1, M_mu_eps, [0 200], time_points1, pert_matrix1, C_diff);
subplot(3,1,1)
h=area(t1,simulatedAbundance1(:,1:11));
...
[t2,simulatedAbundance2] = eglv_simulation(Xinit2, M_mu_eps, [0 200], time_points2, pert_matrix2, C_diff);
subplot(3,1,2)
