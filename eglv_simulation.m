function [tResult, xResult] = eglv_simulation(Xinit, M_mu_eps, time, time_points, pert_matrix, C_diff)
tResult = [];
xResult = [];
...
for index = 2:numel(time_points)
    ...
    [t,simulatedAbundance]  = ode15s(@(t,X) extended_generalized_lotka_volterra_model(t,X,M_mu_eps), t, Xinit, M_mu_eps);
